  ...
  return (
    <section id="work" className="py-20 md:py-28 section-padding bg-warm-950/40" ref={ref}>
      <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto">
        ...
        >
          <p className="text-warm-500 font-mono text-xs mb-2 tracking-[0.15em] uppercase">
            {builtSection.kicker}
          </p>
          <p className="text-warm-400 text-base md:text-[17px] leading-relaxed">
            {builtSection.intro}
          </p>
        </motion.div>
              ...
              >
                {idx === 0 && (
                  <div className="mb-8 md:mb-10">
                    <h3 className="text-xs font-mono uppercase tracking-[0.2em] text-warm-500 mb-2">
                      Tellen
                    </h3>
                ...
                {idx === 2 && (
                  <h3 className="text-xs font-mono uppercase tracking-[0.2em] text-warm-500 mb-6">
                    Antylia Scientific
                  </h3>
                )}
                ...
                <p className="text-warm-300 text-sm md:text-base leading-relaxed mb-6 max-w-2xl">
                  {c.summary}
                </p>

                <div className="mb-8 max-w-3xl">
                  <ArchitectureDiagram
                    steps={c.diagramSteps}
                    variant={c.diagramVariant}
                    caption={c.diagramCaption}
                  />
                </div>

                <div className="grid md:grid-cols-2 gap-4 md:gap-5">
                  <div className={subsectionCard}>
                    <h4 className="text-[10px] font-mono uppercase tracking-widest text-accent-500/90 mb-2">
                      Problem
                    </h4>
                ...
                <div className="mt-6 md:mt-8 rounded-xl border border-accent-500/25 border-l-4 border-l-accent-500/70 bg-warm-900/80 ring-1 ring-accent-500/10 shadow-lg shadow-black/20 px-5 py-5 md:px-7 md:py-6 max-w-4xl">
                  <h4 className="text-[10px] font-mono uppercase tracking-widest text-accent-400 mb-2">
                    Result / impact
                  </h4>
                  <p className="text-warm-100/95 text-sm md:text-base leading-relaxed font-medium">
                    {c.result}
                  </p>
                </div>
              </motion.article>

  ...
  buckets: [
    {
      ...
      tier: 'primary',
      items: [
        { name: 'LLM application design & RAG patterns' },
        { name: 'Prompt engineering & eval discipline' },
        { name: 'Structured extraction & document parsing' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'API design & background jobs' },
    ...
    },
    {
      ...
      tier: 'secondary',
      items: [
        { name: 'Azure (compute, storage, managed services)' },
        { name: 'Data modeling & pipelines' },
        { name: 'IoT protocols (TCP/IP, MQTT)' },
